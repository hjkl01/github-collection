...
这是一个基于 NestJS 的现代化项目启动模板，提供架构规范与开发环境。支持 Node、Deno 和 Bun 运行时，内置 JWT 认证、Swagger API 文档、多环境配置及最新 TypeScript 支持。集成 ESLint 与 Prettier 代码规范，提供热重载开发体验，并包含详细的架构、命名规范及开发指南。