...
99 是 Neovim 的 AI 客户端插件，采用代理式工作流增强编程体验，旨在融合 LLM 能力辅助而非替代代码编写。

核心功能：
1. 项目搜索：根据提示词全局搜索项目信息，定位结果输出至快速修复列表。
2. 代码替换：支持视觉模式，将选区代码结合提示词替换为 AI 生成内容。
3. 任务管理：通过 Worker 模块持久化跟踪工作任务，利用搜索功能查找待办事项。
