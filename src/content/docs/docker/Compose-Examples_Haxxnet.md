...
该项目提供了大量自托管自由开源及专有软件的 Docker Compose 示例配置。涵盖仪表盘、密码管理、代理、身份认证、AI、VPN、DNS、软件开发、监控、文件同步、多媒体、文档、博客、安全及 Wiki 等类别。用户需自行调整卷路径、权限、网络及密钥配置，适用于本地开发或经安全加固后的生产环境部署。